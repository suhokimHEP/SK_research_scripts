...
void table_stackedRegion(TString region, Bool_t dolog, Bool_t HIP, Bool_t doctau, Bool_t useEOS, TString description)
{
...
// Bool_t drawRatio = kTRUE;
 ...
 TString inpath_NoUnc = inpath+aversion+"/";
 TString inpath_JECUp = inpath+"JECUp_35GeV/";
 TString inpath_JECDown = inpath+"JECDown_35GeV/";
...
variables.push_back("nSelectedAODCaloJetTag");
 ...
 TH1F* h_Sig_JECDown  ;
      FILE * outfulltable;
     TString logname = outpath+"tables/full_text"; 
...
for(unsigned int k=0; k<MSbins.size(); ++k){
 ...
 file_ZH_JECUp                    = TFile::Open( inpath_JECUp +  MSsample+"_"+region+"_histograms.root"                 ) ;
 file_ggZH_JECUp                    = TFile::Open( inpath_JECUp + "gg"+ MSsample+"_"+region+"_histograms.root"                 ) ;
 file_ZH_NoUnc                    = TFile::Open( inpath_NoUnc +  MSsample+"_"+region+"_histograms.root"                 ) ;
 file_ggZH_NoUnc                   = TFile::Open( inpath_NoUnc + "gg"+ MSsample+"_"+region+"_histograms.root"                 ) ;
 file_ZH_JECDown                    = TFile::Open( inpath_JECDown +  MSsample+"_"+region+"_histograms.root"                 ) ;
 file_ggZH_JECDown                    = TFile::Open( inpath_JECDown + "gg"+ MSsample+"_"+region+"_histograms.root"                 ) ;
cout<<"where"<<endl;
  ...
  for(unsigned int j=0; j<variables.size(); ++j){
   ...
   for(unsigned int tt=0; tt<loopEnd; ++tt){
    ...
    if(j==0){
     ...
     h_ZH_JECUp       = (TH1F*)file_ZH_JECUp    ->Get("h_"+varname )->Clone( "ZH_JECUp" ) ;
     h_ZH_JECDown       = (TH1F*)file_ZH_JECDown    ->Get("h_"+varname )->Clone( "ZH_JECDown" ) ;
     h_ggZH_NoUnc       = (TH1F*)file_ggZH_NoUnc    ->Get("h_"+varname )->Clone( "ggZH_NoUnc" ) ;
     h_ggZH_JECUp       = (TH1F*)file_ggZH_JECUp    ->Get("h_"+varname )->Clone( "ggZH_JECUp" ) ;
     h_ggZH_JECDown       = (TH1F*)file_ggZH_JECDown    ->Get("h_"+varname )->Clone( "ggZH_JECDown" ) ;
	...
	cout<<"here"<<endl;
     ...
     h_ggZH_NoUnc   = (TH1F*) h_ggZH_NoUnc    ->Clone( "ggZH_NoUnc " ) ;
     h_ggZH_JECUp   = (TH1F*) h_ggZH_JECUp    ->Clone( "ggZH_JECUp " ) ;
     h_ggZH_JECDown   = (TH1F*) h_ggZH_JECDown    ->Clone( "ggZH_JECDown " ) ;
     // rescale MC to match eras used
     h_ZH_NoUnc  ->Scale(MCSF);
     h_ZH_JECUp  ->Scale(MCSF);
     h_ZH_JECDown  ->Scale(MCSF);
     h_ggZH_NoUnc  ->Scale(MCSF);
     h_ggZH_JECUp  ->Scale(MCSF);
     h_ggZH_JECDown  ->Scale(MCSF);
    
    Float_t ZH_NoUnc_tag0 = h_ZH_NoUnc->GetBinContent(1);
    Float_t ZH_JECUp_tag0 = h_ZH_JECUp->GetBinContent(1);
    Float_t ZH_JECDown_tag0 = h_ZH_JECDown->GetBinContent(1);
    Float_t ggZH_NoUnc_tag0 = h_ggZH_NoUnc->GetBinContent(1);
    Float_t ggZH_JECUp_tag0 = h_ggZH_JECUp->GetBinContent(1);
    Float_t ggZH_JECDown_tag0 = h_ggZH_JECDown->GetBinContent(1);
    Float_t ZH_NoUnc_tag1 = h_ZH_NoUnc->GetBinContent(2);
    Float_t ZH_JECUp_tag1 = h_ZH_JECUp->GetBinContent(2);
    Float_t ZH_JECDown_tag1 = h_ZH_JECDown->GetBinContent(2);
    Float_t ggZH_NoUnc_tag1 = h_ggZH_NoUnc->GetBinContent(2);
    Float_t ggZH_JECUp_tag1 = h_ggZH_JECUp->GetBinContent(2);
    Float_t ggZH_JECDown_tag1 = h_ggZH_JECDown->GetBinContent(2);
    Float_t ZH_NoUnc_tag2 = h_ZH_NoUnc->GetBinContent(3);
    Float_t ZH_JECUp_tag2 = h_ZH_JECUp->GetBinContent(3);
    Float_t ZH_JECDown_tag2 = h_ZH_JECDown->GetBinContent(3);
    Float_t ggZH_NoUnc_tag2 = h_ggZH_NoUnc->GetBinContent(3);
    Float_t ggZH_JECUp_tag2 = h_ggZH_JECUp->GetBinContent(3);
    Float_t ggZH_JECDown_tag2 = h_ggZH_JECDown->GetBinContent(3);
     ...
     //h_Sig_NoUnc->Add(h_ggZH_NoUnc);
     //h_Sig_JECUp->Add(h_ggZH_JECUp);
     //h_Sig_JECDown->Add(h_ggZH_JECDown);
