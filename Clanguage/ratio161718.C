...
Regions.push_back("TwoEleDY");

std::vector<TString> TV;
TV.push_back("MedianLog10TrackAngle");
TV.push_back("MedianLog10IPSig");
...
h0=(TH1F*)_file0->Get("h_"+Channel+"_AllJets_AODCaloJet"+Var)->Clone("h0");
h1=(TH1F*)_file1->Get("h_"+Channel+"_AllJets_AODCaloJet"+Var)->Clone("h1");
...
legend =  new TLegend(0.15,0.65,0.35,0.75); 		
