...
void tau_ctauSigstackedRegion(TString region, Bool_t dolog, Bool_t HIP, Bool_t useEOS, TString description)
{
...
// //TFile* file_Data_SingleEle_B_2      ; 
 ...
 TFile* file_Sig_ZH_MS7ct1000     ;
 TFile* file_Sig_ZH_MS7ct100      ;
 TFile* file_Sig_ZH_MS7ct10       ;
 TFile* file_Sig_ZH_MS7ct1        ;
 ...
 TFile* file_Sig_ggZH_MS7ct1000   ;
 TFile* file_Sig_ggZH_MS7ct100    ;
 TFile* file_Sig_ggZH_MS7ct10     ;
 TFile* file_Sig_ggZH_MS7ct1      ;
 ...
 file_Sig_ZH_MS7ct1000  = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-7_ctauS-1000_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS7ct100   = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-7_ctauS-100_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS7ct10    = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-7_ctauS-10_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS7ct1     = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-7_ctauS-1_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS15ct1000  = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-15_ctauS-1000_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS15ct100   = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-15_ctauS-100_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS15ct10    = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-15_ctauS-10_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS15ct1     = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-15_ctauS-1_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS40ct1000  = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-40_ctauS-1000_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS40ct100   = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-40_ctauS-100_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS40ct10    = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-40_ctauS-10_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS40ct1     = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-40_ctauS-1_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS55ct1000  = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-55_ctauS-1000_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS55ct100   = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-55_ctauS-100_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS55ct10    = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-55_ctauS-10_"+region+"_histograms.root"   ) ; 
 file_Sig_ZH_MS55ct1     = TFile::Open( inpath + "ZH_HToSSTo4Tau_ZToLL_MH-125_MS-55_ctauS-1_"+region+"_histograms.root"   ) ; 

 file_Sig_ggZH_MS7ct1000  = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-7_ctauS-1000_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS7ct100   = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-7_ctauS-100_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS7ct10    = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-7_ctauS-10_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS7ct1     = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-7_ctauS-1_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS15ct1000  = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-15_ctauS-1000_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS15ct100   = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-15_ctauS-100_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS15ct10    = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-15_ctauS-10_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS15ct1     = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-15_ctauS-1_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS40ct1000  = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-40_ctauS-1000_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS40ct100   = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-40_ctauS-100_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS40ct10    = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-40_ctauS-10_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS40ct1     = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-40_ctauS-1_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS55ct1000  = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-55_ctauS-1000_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS55ct100   = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-55_ctauS-100_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS55ct10    = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-55_ctauS-10_"+region+"_histograms.root"   ) ; 
 file_Sig_ggZH_MS55ct1     = TFile::Open( inpath + "ggZH_HToSSTo4Tau_ZToLL_MH-125_MS-55_ctauS-1_"+region+"_histograms.root"   ) ; 
...
//     fprintf (outfulltable, "Data DoubleEG B 2       & %3.1f \\\\\n", int_Data_DoubleEG_B_2      ) ; 
       ...
       //fprintf (outfulltable, "ggZH\\_HToSSTo4Tau\\_MS40\\_ctauS10000  & %3.1f  \\\\\n", int_ggZH_HToSSTo4Tau_MS40_ctauS10000 ) ;
...
//     if( h_ggZH_HToSSTo4Tau_MS40_ctauS0     ->Integral(0,-1) > 0.1){ ;
//        h_ggZH_HToSSTo4Tau_MS40_ctauS0      ->Scale( int_bkgtotal / h_ggZH_HToSSTo4Tau_MS40_ctauS0     ->Integral(0,-1));
//     }                                     
//     if( h_ggZH_HToSSTo4Tau_MS40_ctauS0p05  ->Integral(0,-1) > 0.1){ ;
//        h_ggZH_HToSSTo4Tau_MS40_ctauS0p05   ->Scale( int_bkgtotal / h_ggZH_HToSSTo4Tau_MS40_ctauS0p05  ->Integral(0,-1));  
//     }                                     
//     if( h_ggZH_HToSSTo4Tau_MS40_ctauS1     ->Integral(0,-1) > 0.1){ ;
//        h_ggZH_HToSSTo4Tau_MS40_ctauS1      ->Scale( int_bkgtotal / h_ggZH_HToSSTo4Tau_MS40_ctauS1     ->Integral(0,-1)); 
//     }                                     
//     if( h_ggZH_HToSSTo4Tau_MS40_ctauS10    ->Integral(0,-1) > 0.1){ ;
//        h_ggZH_HToSSTo4Tau_MS40_ctauS10     ->Scale( int_bkgtotal / h_ggZH_HToSSTo4Tau_MS40_ctauS10    ->Integral(0,-1)); 
//     }                                     
//     if( h_ggZH_HToSSTo4Tau_MS40_ctauS100   ->Integral(0,-1) > 0.1){ ;
//        h_ggZH_HToSSTo4Tau_MS40_ctauS100    ->Scale( int_bkgtotal / h_ggZH_HToSSTo4Tau_MS40_ctauS100   ->Integral(0,-1));   
//     }                                     
//     if( h_ggZH_HToSSTo4Tau_MS40_ctauS1000  ->Integral(0,-1) > 0.1){ ;
//        h_ggZH_HToSSTo4Tau_MS40_ctauS1000   ->Scale( int_bkgtotal / h_ggZH_HToSSTo4Tau_MS40_ctauS1000  ->Integral(0,-1));  
//     }                                     
//     if( h_ggZH_HToSSTo4Tau_MS40_ctauS10000 ->Integral(0,-1) > 0.1){ ;
//        h_ggZH_HToSSTo4Tau_MS40_ctauS10000  ->Scale( int_bkgtotal / h_ggZH_HToSSTo4Tau_MS40_ctauS10000 ->Integral(0,-1) ); 
//     }
     ...
     if(drawSignal){
       ...
       sigleg->AddEntry(h_Sig_MS55ct10    , "Sig(H#rightarrow SS#rightarrow 4Tau): M_{S}=55 c#tau_{S}=10   ", "l" ) ;
       sigleg->AddEntry(h_Sig_MS40ct10    , "Sig(H#rightarrow SS#rightarrow 4Tau): M_{S}=40 c#tau_{S}=10   ", "l" ) ;
       sigleg->AddEntry(h_Sig_MS15ct10    , "Sig(H#rightarrow SS#rightarrow 4Tau): M_{S}=15 c#tau_{S}=10  ", "l" ) ;
       sigleg->AddEntry(h_Sig_MS7ct10    , "Sig(H#rightarrow SS#rightarrow 4Tau): M_{S}=7 c#tau_{S}=10  ", "l" ) ;
     }
     // TLine
     ...
     h_bkgtotal->GetYaxis()->SetRangeUser(0.001,1.2);
     ...
     if(drawSignal){
       h_Sig_MS55ct10->SetLineColor(kBlue);
       h_Sig_MS40ct10->SetLineColor(kGreen);
       h_Sig_MS15ct10->SetLineColor(kMagenta);
       h_Sig_MS7ct10->SetLineColor(kYellow);
       h_Sig_MS55ct10->SetLineWidth(4);
       h_Sig_MS40ct10->SetLineWidth(4);
       h_Sig_MS15ct10->SetLineWidth(4);
       h_Sig_MS7ct10->SetLineWidth(4);
       h_Sig_MS55ct10->SetLineStyle(1);
       h_Sig_MS40ct10->SetLineStyle(1);
       h_Sig_MS7ct10->SetLineStyle(1);
       h_Sig_MS15ct10->SetLineStyle(1);
       h_Sig_MS55ct10->Scale(1/h_Sig_MS55ct10->Integral(0,-1));
       h_Sig_MS40ct10->Scale(1/h_Sig_MS40ct10->Integral(0,-1));
       h_Sig_MS15ct10->Scale(1/h_Sig_MS15ct10->Integral(0,-1));
       h_Sig_MS7ct10->Scale(1/h_Sig_MS7ct10->Integral(0,-1));
       h_Sig_MS55ct10->Draw("hist sames") ;
       h_Sig_MS40ct10->Draw("hist sames") ;
       h_Sig_MS15ct10->Draw("hist sames") ;
       h_Sig_MS7ct10->Draw("hist sames") ;
       sigleg->Draw();
     }
     leg->Draw();
