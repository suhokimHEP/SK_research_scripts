...
void print_hist(TH2F* h, TString name, FILE* file){
...
void plotter_2DstackedRegion(TString region, Bool_t dolog, Bool_t HIP, Bool_t useEOS, TString description)
{
...
////variables.push_back("AllJets_AODCaloJet_Study_trk0_AlphaMax");
////variables.push_back("AllJets_AODCaloJet_Study_trk0_MedianLog10IPSig");
////variables.push_back("AllJets_AODCaloJet_Study_trk0_MedianLog10TrackAngle");
////variables.push_back("AllJets_AODCaloJet_Study_ptG0p5_AlphaMax");
////variables.push_back("AllJets_AODCaloJet_Study_ptG0p5_MedianLog10IPSig");
////variables.push_back("AllJets_AODCaloJet_Study_ptG0p5_MedianLog10TrackAngle");
////variables.push_back("AllJets_AODCaloJet_Study_ptG10_AlphaMax");
////variables.push_back("AllJets_AODCaloJet_Study_ptG10_MedianLog10IPSig");
////variables.push_back("AllJets_AODCaloJet_Study_ptG10_MedianLog10TrackAngle");
//variables.push_back("AllJets_AODCaloJet_Study_n_v_AlphaMax");
variables.push_back("AllJets_AODCaloJet_Study_pt_v_AlphaMax");
//variables.push_back("AllJets_AODCaloJet_Study_n_v_MedianLog10IPSig");
//variables.push_back("AllJets_AODCaloJet_Study_n_v_MedianLog10TrackAngle");
////variables.push_back("AllJets_AODCaloJet_Study_pt_v_AlphaMax");
////variables.push_back("AllJets_AODCaloJet_Study_pt_v_MedianLog10IPSig");
////variables.push_back("AllJets_AODCaloJet_Study_pt_v_MedianLog10TrackAngle");
 ...
 TPad *plotpad  = new TPad("plotpad", "plotpad", 0, 0.1, 1, .9);
 ...
 canvas->cd();
 TPad *ratiopad = new TPad("ratiopad", "ratiopad", 0, 0, 1, 0.15);
...
// //TFile* file_Data_SingleEle_B_2      ; 
 ...
 // initialize histos
 TH2F* h_DY50                                ;
 TH2F* h_DY5to50_HT100To200                  ; 
 TH2F* h_DY5to50_HT200To400                  ; 
 TH2F* h_DY5to50_HT400To600                  ; 
 TH2F* h_DY5to50_HT600ToInf                  ; 
 TH2F* h_DY10to50                            ; 
 TH2F* h_ggZH_HToBB_ZToLL                    ;
 TH2F* h_GJets_HT40To100                     ;
 TH2F* h_GJets_HT100To200                    ;
 TH2F* h_GJets_HT200To400                    ;
 TH2F* h_GJets_HT400To600                    ;
 TH2F* h_GJets_HT600ToInf                    ;
 TH2F* h_ST_s                                ;
 TH2F* h_STbar_t                             ;
 TH2F* h_ST_t                                ;
 TH2F* h_STbar_tW                            ;
 ...
 TH2F* h_WZTo1L3Nu                           ;
 TH2F* h_WZTo3LNu                            ;
 TH2F* h_WZToLNu2QorQQ2L                     ;
 TH2F* h_ZG                                  ;
 TH2F* h_ZH_HToBB_ZToLL                      ;
 TH2F* h_ZZ                                  ;
 TH2F* h_ZZTo2L2Nu                           ;
 TH2F* h_ZZTo2L2Q                            ;
 TH2F* h_ZZTo2Q2Nu                           ;
 TH2F* h_ZZTo4L                              ;
 TH2F* h_QCD_HT100to200                      ;
 TH2F* h_QCD_HT200to300                      ;
 TH2F* h_QCD_HT300to500                      ;
 TH2F* h_QCD_HT500to700                      ;
 TH2F* h_QCD_HT700to1000                     ;
 TH2F* h_QCD_HT1000to1500                    ;
 TH2F* h_QCD_HT1500to2000                    ;
 TH2F* h_QCD_HT2000toInf                     ;
 TH2F* h_Sig_ZH_MS15ct1000     ;
 TH2F* h_Sig_ZH_MS15ct100      ;
 TH2F* h_Sig_ZH_MS15ct10       ;
 TH2F* h_Sig_ZH_MS15ct1        ;
 TH2F* h_Sig_ZH_MS40ct1000     ;
 TH2F* h_Sig_ZH_MS40ct100      ;
 TH2F* h_Sig_ZH_MS40ct10       ;
 TH2F* h_Sig_ZH_MS40ct1        ;
 TH2F* h_Sig_ZH_MS55ct1000     ;
 TH2F* h_Sig_ZH_MS55ct100      ;
 TH2F* h_Sig_ZH_MS55ct10       ;
 TH2F* h_Sig_ZH_MS55ct1        ;
 TH2F* h_Sig_ggZH_MS15ct1000   ;
 TH2F* h_Sig_ggZH_MS15ct100    ;
 TH2F* h_Sig_ggZH_MS15ct10     ;
 TH2F* h_Sig_ggZH_MS15ct1      ;
 TH2F* h_Sig_ggZH_MS40ct1000   ;
 TH2F* h_Sig_ggZH_MS40ct100    ;
 TH2F* h_Sig_ggZH_MS40ct10     ;
 TH2F* h_Sig_ggZH_MS40ct1      ;
 TH2F* h_Sig_ggZH_MS55ct1000   ;
 TH2F* h_Sig_ggZH_MS55ct100    ;
 TH2F* h_Sig_ggZH_MS55ct10     ;
 TH2F* h_Sig_ggZH_MS55ct1      ;
 //TH2F* h_Data_SingleMu_H_3     ;
 //TH2F* h_Data_SingleMu_H_2     ;
 //TH2F* h_Data_SingleMu_G       ;
 ////TH2F* h_Data_SingleMu_F       ;
 ////TH2F* h_Data_SingleMu_E       ;
 ////TH2F* h_Data_SingleMu_D       ;
 ////TH2F* h_Data_SingleMu_C       ;
 ////TH2F* h_Data_SingleMu_B_2     ;
 //TH2F* h_Data_SingleEle_H_3    ;
 //TH2F* h_Data_SingleEle_H_2    ;
 //TH2F* h_Data_SingleEle_G      ;
 ////TH2F* h_Data_SingleEle_F      ;
 ////TH2F* h_Data_SingleEle_E      ;
 ////TH2F* h_Data_SingleEle_D      ;
 ////TH2F* h_Data_SingleEle_C      ;
 ////TH2F* h_Data_SingleEle_B_2    ;
 TH2F* h_Data_MuonEG_H_3       ;
 TH2F* h_Data_MuonEG_H_2       ;
 TH2F* h_Data_MuonEG_G         ;
 //TH2F* h_Data_MuonEG_F         ;
 //TH2F* h_Data_MuonEG_E         ;
 //TH2F* h_Data_MuonEG_D         ;
 //TH2F* h_Data_MuonEG_C         ;
 //TH2F* h_Data_MuonEG_B_2       ;
 TH2F* h_Data_SinglePhoton_H_3 ;
 TH2F* h_Data_SinglePhoton_H_2 ;
 TH2F* h_Data_SinglePhoton_G   ;
 //TH2F* h_Data_SinglePhoton_F   ;
 //TH2F* h_Data_SinglePhoton_E   ;
 //TH2F* h_Data_SinglePhoton_D   ;
 //TH2F* h_Data_SinglePhoton_C   ;
 //TH2F* h_Data_SinglePhoton_B_2 ;
 TH2F* h_Data_DoubleMu_H_3     ;
 TH2F* h_Data_DoubleMu_H_2     ;
 TH2F* h_Data_DoubleMu_G       ;
 //TH2F* h_Data_DoubleMu_F       ;
 //TH2F* h_Data_DoubleMu_E       ;
 //TH2F* h_Data_DoubleMu_D       ;
 //TH2F* h_Data_DoubleMu_C       ;
 //TH2F* h_Data_DoubleMu_B_2     ;
 TH2F* h_Data_DoubleEG_H_3     ;
 TH2F* h_Data_DoubleEG_H_2     ;
 TH2F* h_Data_DoubleEG_G       ;
 //TH2F* h_Data_DoubleEG_F       ;
 //TH2F* h_Data_DoubleEG_E       ;
 //TH2F* h_Data_DoubleEG_D       ;
 //TH2F* h_Data_DoubleEG_C       ;
 //TH2F* h_Data_DoubleEG_B_2     ;
 TH2F* h_ratio ;
 TH2F* h_ratiostaterr ;
 ...
 TH2F* h_Sig_MS15ct1000 ;
 TH2F* h_Sig_MS15ct100  ;
 TH2F* h_Sig_MS15ct10   ;
 TH2F* h_Sig_MS15ct1    ;
 TH2F* h_Sig_MS40ct1000 ;
 TH2F* h_Sig_MS40ct100  ;
 TH2F* h_Sig_MS40ct10   ;
 TH2F* h_Sig_MS40ct1    ;
 TH2F* h_Sig_MS55ct1000 ;
 TH2F* h_Sig_MS55ct100  ;
 TH2F* h_Sig_MS55ct10   ;
 TH2F* h_Sig_MS55ct1    ;
  ...
  for(unsigned int j=0; j<variables.size(); ++j){
   ...
   for(unsigned int tt=0; tt<loopEnd; ++tt){
    ...
    if(j==0){
     ...
     //h_DY5to50_HT70To100               = (TH2F*)file_DY5to50_HT70To100                ->Get("h_"+varname)->Clone( "h_DY5to50_HT70To100"           +uncbin     ) ; 
     h_DY5to50_HT100To200              = (TH2F*)file_DY5to50_HT100To200               ->Get("h_"+varname+uncbin)->Clone( "DY5to50_HT100To200"              +uncbin ) ; 
     h_DY5to50_HT200To400              = (TH2F*)file_DY5to50_HT200To400               ->Get("h_"+varname+uncbin)->Clone( "DY5to50_HT200To400"              +uncbin ) ; 
     h_DY5to50_HT400To600              = (TH2F*)file_DY5to50_HT400To600               ->Get("h_"+varname+uncbin)->Clone( "DY5to50_HT400To600"              +uncbin ) ; 
     h_DY5to50_HT600ToInf              = (TH2F*)file_DY5to50_HT600ToInf               ->Get("h_"+varname+uncbin)->Clone( "DY5to50_HT600ToInf"              +uncbin ) ; 
     h_DY10to50                        = (TH2F*)file_DY10to50                         ->Get("h_"+varname+uncbin)->Clone( "DY10to50"                        +uncbin ) ;
     h_DY50                            = (TH2F*)file_DY50                             ->Get("h_"+varname+uncbin)->Clone( "DY50"                            +uncbin ) ;

     h_ggZH_HToBB_ZToLL                = (TH2F*)file_ggZH_HToBB_ZToLL                 ->Get("h_"+varname+uncbin)->Clone( "ggZH_HToBB_ZToLL"                +uncbin ) ;
     h_ZH_HToBB_ZToLL                  = (TH2F*)file_ZH_HToBB_ZToLL                   ->Get("h_"+varname+uncbin)->Clone( "ZH_HToBB_ZToLL"                  +uncbin ) ;

     h_GJets_HT40To100                 = (TH2F*)file_GJets_HT40To100                  ->Get("h_"+varname+uncbin)->Clone( "GJets_HT40To100"                 +uncbin ) ;
     h_GJets_HT100To200                = (TH2F*)file_GJets_HT100To200                 ->Get("h_"+varname+uncbin)->Clone( "GJets_HT100To200"                +uncbin ) ;
     h_GJets_HT200To400                = (TH2F*)file_GJets_HT200To400                 ->Get("h_"+varname+uncbin)->Clone( "GJets_HT200To400"                +uncbin ) ;
     h_GJets_HT400To600                = (TH2F*)file_GJets_HT400To600                 ->Get("h_"+varname+uncbin)->Clone( "GJets_HT400To600"                +uncbin ) ;
     h_GJets_HT600ToInf                = (TH2F*)file_GJets_HT600ToInf                 ->Get("h_"+varname+uncbin)->Clone( "GJets_HT600ToInf"                +uncbin ) ;

     h_ST_s                            = (TH2F*)file_ST_s                             ->Get("h_"+varname+uncbin)->Clone( "ST_s"                            +uncbin ) ;
     h_STbar_t                         = (TH2F*)file_STbar_t                          ->Get("h_"+varname+uncbin)->Clone( "STbar_t"                         +uncbin ) ;
     h_ST_t                            = (TH2F*)file_ST_t                             ->Get("h_"+varname+uncbin)->Clone( "ST_t"                            +uncbin ) ;
     h_STbar_tW                        = (TH2F*)file_STbar_tW                         ->Get("h_"+varname+uncbin)->Clone( "STbar_tW"                        +uncbin ) ;
     h_ST_tW                           = (TH2F*)file_ST_tW                            ->Get("h_"+varname+uncbin)->Clone( "ST_tW"                           +uncbin ) ;

     h_TTJets                          = (TH2F*)file_TTJets                           ->Get("h_"+varname+uncbin)->Clone( "TTJets"                          +uncbin ) ;
     h_TTtoLL                          = (TH2F*)file_TTtoLL                           ->Get("h_"+varname+uncbin)->Clone( "TTtoLL"                          +uncbin ) ;
     h_TTtoLfromTbar                   = (TH2F*)file_TTtoLfromTbar                    ->Get("h_"+varname+uncbin)->Clone( "TTtoLfromTbar"                   +uncbin ) ;
     h_TTtoLfromT                      = (TH2F*)file_TTtoLfromT                       ->Get("h_"+varname+uncbin)->Clone( "TTtoLfromT"                      +uncbin ) ;
     h_WJetsToLNu                      = (TH2F*)file_WJetsToLNu                       ->Get("h_"+varname+uncbin)->Clone( "WJetsToLNu"                      +uncbin ) ;
     h_WG                              = (TH2F*)file_WG                               ->Get("h_"+varname+uncbin)->Clone( "WG"                              +uncbin ) ;
     h_ZG                              = (TH2F*)file_ZGTo2LG                          ->Get("h_"+varname+uncbin)->Clone( "ZG"                              +uncbin ) ;
     h_WW                              = (TH2F*)file_WW                               ->Get("h_"+varname+uncbin)->Clone( "WW"                              +uncbin ) ;
     h_WZ                              = (TH2F*)file_WZ                               ->Get("h_"+varname+uncbin)->Clone( "WZ"                              +uncbin ) ;
     h_ZZ                              = (TH2F*)file_ZZ                               ->Get("h_"+varname+uncbin)->Clone( "ZZ"                              +uncbin ) ;
     h_WWTo2L2Nu                       = (TH2F*)file_WWTo2L2Nu                        ->Get("h_"+varname+uncbin)->Clone( "WWTo2L2Nu"                       +uncbin ) ;
     h_WWToLNuQQ                       = (TH2F*)file_WWToLNuQQ                        ->Get("h_"+varname+uncbin)->Clone( "WWToLNuQQ"                       +uncbin ) ;
     h_WZTo1L3Nu                       = (TH2F*)file_WZTo1L3Nu                        ->Get("h_"+varname+uncbin)->Clone( "WZTo1L3Nu"                       +uncbin ) ;
     h_WZTo3LNu                        = (TH2F*)file_WZTo3LNu                         ->Get("h_"+varname+uncbin)->Clone( "WZTo3LNu"                        +uncbin ) ;
     h_WZToLNu2QorQQ2L                 = (TH2F*)file_WZToLNu2QorQQ2L                  ->Get("h_"+varname+uncbin)->Clone( "WZToLNu2QorQQ2L"                 +uncbin ) ;
     h_ZZTo2L2Nu                       = (TH2F*)file_ZZTo2L2Nu                        ->Get("h_"+varname+uncbin)->Clone( "ZZTo2L2Nu"                       +uncbin ) ;
     h_ZZTo2L2Q                        = (TH2F*)file_ZZTo2L2Q                         ->Get("h_"+varname+uncbin)->Clone( "ZZTo2L2Q"                        +uncbin ) ;
     h_ZZTo2Q2Nu                       = (TH2F*)file_ZZTo2Q2Nu                        ->Get("h_"+varname+uncbin)->Clone( "ZZTo2Q2Nu"                       +uncbin ) ;
     h_ZZTo4L                          = (TH2F*)file_ZZTo4L                           ->Get("h_"+varname+uncbin)->Clone( "ZZTo4L"                          +uncbin ) ;
     h_QCD_HT100to200                  = (TH2F*)file_QCD_HT100to200                   ->Get("h_"+varname+uncbin)->Clone( "QCD_HT100to200"                +uncbin   ) ;
     h_QCD_HT200to300                  = (TH2F*)file_QCD_HT200to300                   ->Get("h_"+varname+uncbin)->Clone( "QCD_HT200to300"                +uncbin   ) ;
     h_QCD_HT300to500                  = (TH2F*)file_QCD_HT300to500                   ->Get("h_"+varname+uncbin)->Clone( "QCD_HT300to500"                +uncbin   ) ;
     h_QCD_HT500to700                  = (TH2F*)file_QCD_HT500to700                   ->Get("h_"+varname+uncbin)->Clone( "QCD_HT500to700"                +uncbin   ) ;
     h_QCD_HT700to1000                 = (TH2F*)file_QCD_HT700to1000                  ->Get("h_"+varname+uncbin)->Clone( "QCD_HT700to1000"               +uncbin   ) ;
     h_QCD_HT1000to1500                = (TH2F*)file_QCD_HT1000to1500                 ->Get("h_"+varname+uncbin)->Clone( "QCD_HT1000to1500"              +uncbin   ) ;
     h_QCD_HT1500to2000                = (TH2F*)file_QCD_HT1500to2000                 ->Get("h_"+varname+uncbin)->Clone( "QCD_HT1500to2000"              +uncbin   ) ;
     h_QCD_HT2000toInf                 = (TH2F*)file_QCD_HT2000toInf                  ->Get("h_"+varname+uncbin)->Clone( "QCD_HT2000toInf"               +uncbin   ) ;

     h_Sig_ZH_MS15ct1000   = (TH2F*)file_Sig_ZH_MS15ct1000   ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS15ct1000"+uncbin ) ;
     h_Sig_ZH_MS15ct100    = (TH2F*)file_Sig_ZH_MS15ct100    ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS15ct100" +uncbin ) ;
     h_Sig_ZH_MS15ct10     = (TH2F*)file_Sig_ZH_MS15ct10     ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS15ct10"  +uncbin ) ;
     h_Sig_ZH_MS15ct1      = (TH2F*)file_Sig_ZH_MS15ct1      ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS15ct1"   +uncbin ) ;
     h_Sig_ZH_MS40ct1000   = (TH2F*)file_Sig_ZH_MS40ct1000   ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS40ct1000"+uncbin ) ;
     h_Sig_ZH_MS40ct100    = (TH2F*)file_Sig_ZH_MS40ct100    ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS40ct100" +uncbin ) ;
     h_Sig_ZH_MS40ct10     = (TH2F*)file_Sig_ZH_MS40ct10     ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS40ct10"  +uncbin ) ;
     h_Sig_ZH_MS40ct1      = (TH2F*)file_Sig_ZH_MS40ct1      ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS40ct1"   +uncbin ) ;
     h_Sig_ZH_MS55ct1000   = (TH2F*)file_Sig_ZH_MS55ct1000   ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS55ct1000"+uncbin ) ;
     h_Sig_ZH_MS55ct100    = (TH2F*)file_Sig_ZH_MS55ct100    ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS55ct100" +uncbin ) ;
     h_Sig_ZH_MS55ct10     = (TH2F*)file_Sig_ZH_MS55ct10     ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS55ct10"  +uncbin ) ;
     h_Sig_ZH_MS55ct1      = (TH2F*)file_Sig_ZH_MS55ct1      ->Get("h_"+varname+uncbin )->Clone( "Sig_ZH_MS55ct1"   +uncbin ) ;
														      
     h_Sig_ggZH_MS15ct1000 = (TH2F*)file_Sig_ggZH_MS15ct1000 ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS15ct1000"+uncbin ) ;
     h_Sig_ggZH_MS15ct100  = (TH2F*)file_Sig_ggZH_MS15ct100  ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS15ct100" +uncbin ) ;
     h_Sig_ggZH_MS15ct10   = (TH2F*)file_Sig_ggZH_MS15ct10   ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS15ct10"  +uncbin ) ;
     h_Sig_ggZH_MS15ct1    = (TH2F*)file_Sig_ggZH_MS15ct1    ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS15ct1"   +uncbin ) ;
     h_Sig_ggZH_MS40ct1000 = (TH2F*)file_Sig_ggZH_MS40ct1000 ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS40ct1000"+uncbin ) ;
     h_Sig_ggZH_MS40ct100  = (TH2F*)file_Sig_ggZH_MS40ct100  ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS40ct100" +uncbin ) ;
     h_Sig_ggZH_MS40ct10   = (TH2F*)file_Sig_ggZH_MS40ct10   ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS40ct10"  +uncbin ) ;
     h_Sig_ggZH_MS40ct1    = (TH2F*)file_Sig_ggZH_MS40ct1    ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS40ct1"   +uncbin ) ;
     h_Sig_ggZH_MS55ct1000 = (TH2F*)file_Sig_ggZH_MS55ct1000 ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS55ct1000"+uncbin ) ;
     h_Sig_ggZH_MS55ct100  = (TH2F*)file_Sig_ggZH_MS55ct100  ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS55ct100" +uncbin ) ;
     h_Sig_ggZH_MS55ct10   = (TH2F*)file_Sig_ggZH_MS55ct10   ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS55ct10"  +uncbin ) ;
     h_Sig_ggZH_MS55ct1    = (TH2F*)file_Sig_ggZH_MS55ct1    ->Get("h_"+varname+uncbin )->Clone( "Sig_ggZH_MS55ct1"   +uncbin ) ;

     /*
     h_Data_SingleMu_H_3     = (TH2F*) file_Data_SingleMu_H_3     -> Get("h_"+varname)->Clone( "Data_SingleMu_H_3"      ) ; 
     h_Data_SingleMu_H_2     = (TH2F*) file_Data_SingleMu_H_2     -> Get("h_"+varname)->Clone( "Data_SingleMu_H_2"      ) ; 
     h_Data_SingleMu_G       = (TH2F*) file_Data_SingleMu_G       -> Get("h_"+varname)->Clone( "Data_SingleMu_G"        ) ; 
     //h_Data_SingleMu_F       = (TH2F*) file_Data_SingleMu_F       -> Get("h_"+varname)->Clone( "Data_SingleMu_F"        ) ; 
     //h_Data_SingleMu_E       = (TH2F*) file_Data_SingleMu_E       -> Get("h_"+varname)->Clone( "Data_SingleMu_E"        ) ; 
     //h_Data_SingleMu_D       = (TH2F*) file_Data_SingleMu_D       -> Get("h_"+varname)->Clone( "Data_SingleMu_D"        ) ; 
     //h_Data_SingleMu_C       = (TH2F*) file_Data_SingleMu_C       -> Get("h_"+varname)->Clone( "Data_SingleMu_C"        ) ; 
     //h_Data_SingleMu_B_2     = (TH2F*) file_Data_SingleMu_B_2     -> Get("h_"+varname)->Clone( "Data_SingleMu_B_2"      ) ; 
     h_Data_SingleEle_H_3    = (TH2F*) file_Data_SingleEle_H_3    -> Get("h_"+varname)->Clone( "Data_SingleEle_H_3"     ) ; 
     h_Data_SingleEle_H_2    = (TH2F*) file_Data_SingleEle_H_2    -> Get("h_"+varname)->Clone( "Data_SingleEle_H_2"     ) ; 
     h_Data_SingleEle_G      = (TH2F*) file_Data_SingleEle_G    -> Get("h_"+varname)->Clone( "Data_SingleEle_G"     ) ; 
     //h_Data_SingleEle_F      = (TH2F*) file_Data_SingleEle_F      -> Get("h_"+varname)->Clone( "Data_SingleEle_F"       ) ; 
     //h_Data_SingleEle_E      = (TH2F*) file_Data_SingleEle_E      -> Get("h_"+varname)->Clone( "Data_SingleEle_E"       ) ; 
     //h_Data_SingleEle_D      = (TH2F*) file_Data_SingleEle_D      -> Get("h_"+varname)->Clone( "Data_SingleEle_D"       ) ; 
     //h_Data_SingleEle_C      = (TH2F*) file_Data_SingleEle_C      -> Get("h_"+varname)->Clone( "Data_SingleEle_C"       ) ; 
     //h_Data_SingleEle_B_2    = (TH2F*) file_Data_SingleEle_B_2    -> Get("h_"+varname)->Clone( "Data_SingleEle_B_2"     ) ; 
     */
     h_Data_SinglePhoton_H_3 = (TH2F*) file_Data_SinglePhoton_H_3 -> Get("h_"+varname)->Clone( "Data_SinglePhoton_H_3"  ) ; 
     h_Data_SinglePhoton_H_2 = (TH2F*) file_Data_SinglePhoton_H_2 -> Get("h_"+varname)->Clone( "Data_SinglePhoton_H_2"  ) ; 
     h_Data_SinglePhoton_G   = (TH2F*) file_Data_SinglePhoton_G   -> Get("h_"+varname)->Clone( "Data_SinglePhoton_G"    ) ; 
     //h_Data_SinglePhoton_F   = (TH2F*) file_Data_SinglePhoton_F   -> Get("h_"+varname)->Clone( "Data_SinglePhoton_F"    ) ; 
     //h_Data_SinglePhoton_E   = (TH2F*) file_Data_SinglePhoton_E   -> Get("h_"+varname)->Clone( "Data_SinglePhoton_E"    ) ; 
     //h_Data_SinglePhoton_D   = (TH2F*) file_Data_SinglePhoton_D   -> Get("h_"+varname)->Clone( "Data_SinglePhoton_D"    ) ; 
     //h_Data_SinglePhoton_C   = (TH2F*) file_Data_SinglePhoton_C   -> Get("h_"+varname)->Clone( "Data_SinglePhoton_C"    ) ; 
     //h_Data_SinglePhoton_B_2 = (TH2F*) file_Data_SinglePhoton_B_2 -> Get("h_"+varname)->Clone( "Data_SinglePhoton_B_2"  ) ; 
     h_Data_DoubleMu_H_3     = (TH2F*) file_Data_DoubleMu_H_3     -> Get("h_"+varname)->Clone( "Data_DoubleMu_H_3"      ) ; 
     h_Data_DoubleMu_H_2     = (TH2F*) file_Data_DoubleMu_H_2     -> Get("h_"+varname)->Clone( "Data_DoubleMu_H_2"      ) ; 
     h_Data_DoubleMu_G       = (TH2F*) file_Data_DoubleMu_G       -> Get("h_"+varname)->Clone( "Data_DoubleMu_G"        ) ; 
     //h_Data_DoubleMu_F       = (TH2F*) file_Data_DoubleMu_F       -> Get("h_"+varname)->Clone( "Data_DoubleMu_F"        ) ; 
     //h_Data_DoubleMu_E       = (TH2F*) file_Data_DoubleMu_E       -> Get("h_"+varname)->Clone( "Data_DoubleMu_E"        ) ; 
     //h_Data_DoubleMu_D       = (TH2F*) file_Data_DoubleMu_D       -> Get("h_"+varname)->Clone( "Data_DoubleMu_D"        ) ; 
     //h_Data_DoubleMu_C       = (TH2F*) file_Data_DoubleMu_C       -> Get("h_"+varname)->Clone( "Data_DoubleMu_C"        ) ; 
     //h_Data_DoubleMu_B_2     = (TH2F*) file_Data_DoubleMu_B_2     -> Get("h_"+varname)->Clone( "Data_DoubleMu_B_2"      ) ; 
     h_Data_DoubleEG_H_3     = (TH2F*) file_Data_DoubleEG_H_3     -> Get("h_"+varname)->Clone( "Data_DoubleEG_H_3"      ) ; 
     h_Data_DoubleEG_H_2     = (TH2F*) file_Data_DoubleEG_H_2     -> Get("h_"+varname)->Clone( "Data_DoubleEG_H_2"      ) ; 
     h_Data_DoubleEG_G       = (TH2F*) file_Data_DoubleEG_G       -> Get("h_"+varname)->Clone( "Data_DoubleEG_G"        ) ; 
     //h_Data_DoubleEG_F       = (TH2F*) file_Data_DoubleEG_F       -> Get("h_"+varname)->Clone( "Data_DoubleEG_F"        ) ; 
     //h_Data_DoubleEG_E       = (TH2F*) file_Data_DoubleEG_E       -> Get("h_"+varname)->Clone( "Data_DoubleEG_E"        ) ; 
     //h_Data_DoubleEG_D       = (TH2F*) file_Data_DoubleEG_D       -> Get("h_"+varname)->Clone( "Data_DoubleEG_D"        ) ; 
     //h_Data_DoubleEG_C       = (TH2F*) file_Data_DoubleEG_C       -> Get("h_"+varname)->Clone( "Data_DoubleEG_C"        ) ; 
     //h_Data_DoubleEG_B_2     = (TH2F*) file_Data_DoubleEG_B_2     -> Get("h_"+varname)->Clone( "Data_DoubleEG_B_2"      ) ; 
     h_Data_MuonEG_H_3     = (TH2F*) file_Data_MuonEG_H_3     -> Get("h_"+varname)->Clone( "Data_MuonEG_H_3"      ) ; 
     h_Data_MuonEG_H_2     = (TH2F*) file_Data_MuonEG_H_2     -> Get("h_"+varname)->Clone( "Data_MuonEG_H_2"      ) ; 
     h_Data_MuonEG_G       = (TH2F*) file_Data_MuonEG_G       -> Get("h_"+varname)->Clone( "Data_MuonEG_G"        ) ; 
     //h_Data_MuonEG_F       = (TH2F*) file_Data_MuonEG_F       -> Get("h_"+varname)->Clone( "Data_MuonEG_F"        ) ; 
     //h_Data_MuonEG_E       = (TH2F*) file_Data_MuonEG_E       -> Get("h_"+varname)->Clone( "Data_MuonEG_E"        ) ; 
     //h_Data_MuonEG_D       = (TH2F*) file_Data_MuonEG_D       -> Get("h_"+varname)->Clone( "Data_MuonEG_D"        ) ; 
     //h_Data_MuonEG_C       = (TH2F*) file_Data_MuonEG_C       -> Get("h_"+varname)->Clone( "Data_MuonEG_C"        ) ; 
     //h_Data_MuonEG_B_2     = (TH2F*) file_Data_MuonEG_B_2     -> Get("h_"+varname)->Clone( "Data_MuonEG_B_2"      ) ; 

     // merge histograms
     h_DY = (TH2F*)h_DY50->Clone("DY");
      h_DY->Add(h_DY10to50           ); 

     h_altDY = (TH2F*)h_DY50->Clone("altDY");
     ...
     h_GJets = (TH2F*)h_GJets_HT40To100->Clone("GJets");
      h_GJets->Add(h_GJets_HT100To200);
      h_GJets->Add(h_GJets_HT200To400);
      h_GJets->Add(h_GJets_HT400To600);
      h_GJets->Add(h_GJets_HT600ToInf);

     h_ST = (TH2F*)h_ST_s->Clone("ST");
      h_ST->Add(h_STbar_t);
      h_ST->Add(h_ST_t);
      h_ST->Add(h_STbar_tW);
      h_ST->Add(h_ST_tW);

     h_ZH = (TH2F*)h_ZH_HToBB_ZToLL->Clone("ZH");
      h_ZH->Add(h_ggZH_HToBB_ZToLL);

     h_altVV = (TH2F*)h_WW->Clone("altVV");
      h_altVV->Add(h_WZ             ) ;
      h_altVV->Add(h_ZZ             ) ;

     h_VV = (TH2F*)h_WWTo2L2Nu->Clone("VV");
     ...
     h_altTT = (TH2F*)h_TTJets->Clone("altTT");

     h_TT = (TH2F*)h_TTtoLfromTbar->Clone("TT");
      h_TT->Add(h_TTtoLfromT    );
      h_TT->Add(h_TTtoLL        );
    
     h_VG = (TH2F*)h_WG->Clone("VG");
      h_VG->Add(h_ZG);

     h_QCD = (TH2F*)h_QCD_HT100to200->Clone("QCD");
     ...
     h_Sig_MS15ct1000  = (TH2F*) h_Sig_ZH_MS15ct1000   ->Clone( "Sig_MS15ct1000" ) ;
     h_Sig_MS15ct100   = (TH2F*) h_Sig_ZH_MS15ct100    ->Clone( "Sig_MS15ct100 " ) ;
     h_Sig_MS15ct10    = (TH2F*) h_Sig_ZH_MS15ct10     ->Clone( "Sig_MS15ct10  " ) ;
     h_Sig_MS15ct1     = (TH2F*) h_Sig_ZH_MS15ct1      ->Clone( "Sig_MS15ct1   " ) ;
     h_Sig_MS40ct1000  = (TH2F*) h_Sig_ZH_MS40ct1000   ->Clone( "Sig_MS40ct1000" ) ;
     h_Sig_MS40ct100   = (TH2F*) h_Sig_ZH_MS40ct100    ->Clone( "Sig_MS40ct100 " ) ;
     h_Sig_MS40ct10    = (TH2F*) h_Sig_ZH_MS40ct10     ->Clone( "Sig_MS40ct10  " ) ;
     h_Sig_MS40ct1     = (TH2F*) h_Sig_ZH_MS40ct1      ->Clone( "Sig_MS40ct1   " ) ;
     h_Sig_MS55ct1000  = (TH2F*) h_Sig_ZH_MS55ct1000   ->Clone( "Sig_MS55ct1000" ) ;
     h_Sig_MS55ct100   = (TH2F*) h_Sig_ZH_MS55ct100    ->Clone( "Sig_MS55ct100 " ) ;
     h_Sig_MS55ct10    = (TH2F*) h_Sig_ZH_MS55ct10     ->Clone( "Sig_MS55ct10  " ) ;
     h_Sig_MS55ct1     = (TH2F*) h_Sig_ZH_MS55ct1      ->Clone( "Sig_MS55ct1   " ) ;
     ...
     h_bkgtotal= (TH2F*)h_DY->Clone("bkgtotal");
     ...
     h_light= (TH2F*)h_DY->Clone("light");
      h_light->Add(h_ZG ) ;

     h_light_alt= (TH2F*)h_DY->Clone("light_alt");
      h_light_alt->Add(h_ZG ) ;

     h_other=(TH2F*)h_VV->Clone("other");
      h_other->Add(h_WG);
      h_other->Add(h_QCD);
     ...
     h_other_alt=(TH2F*)h_altVV->Clone("other_alt");
     ...
     h_heavy= (TH2F*)h_TT->Clone("heavy");
      h_heavy->Add(h_ST    ) ;

     h_heavy_alt= (TH2F*)h_altTT->Clone("heavy_alt");
      h_heavy_alt->Add(h_ST    ) ;

     //if( region.Contains("OneEle") ){
     //  //if(HIP){
     //  // h_Data = (TH2F*)h_Data_DoubleEG_B_2->Clone("Data");
   ...
   //    fclose(f);
     ...
     // Integrals
     Float_t  int_DY5to50_HT100To200       = h_DY5to50_HT100To200              ->Integral(0,-1,0,-1); 
     Float_t  int_DY5to50_HT200To400       = h_DY5to50_HT200To400              ->Integral(0,-1,0,-1); 
     Float_t  int_DY5to50_HT400To600       = h_DY5to50_HT400To600              ->Integral(0,-1,0,-1); 
     Float_t  int_DY5to50_HT600ToInf       = h_DY5to50_HT600ToInf              ->Integral(0,-1,0,-1); 
     Float_t  int_DY10to50                 = h_DY10to50                        ->Integral(0,-1,0,-1); 
     Float_t  int_DY50                     = h_DY50                            ->Integral(0,-1,0,-1); 

     Float_t  int_ggZH_HToBB_ZToLL         = h_ggZH_HToBB_ZToLL                ->Integral(0,-1,0,-1); 
     Float_t  int_ZH_HToBB_ZToLL           = h_ZH_HToBB_ZToLL                  ->Integral(0,-1,0,-1); 

     Float_t  int_GJets_HT40To100          = h_GJets_HT40To100                 ->Integral(0,-1,0,-1); 
     Float_t  int_GJets_HT100To200         = h_GJets_HT100To200                ->Integral(0,-1,0,-1); 
     Float_t  int_GJets_HT200To400         = h_GJets_HT200To400                ->Integral(0,-1,0,-1); 
     Float_t  int_GJets_HT400To600         = h_GJets_HT400To600                ->Integral(0,-1,0,-1); 
     Float_t  int_GJets_HT600ToInf         = h_GJets_HT600ToInf                ->Integral(0,-1,0,-1); 

     Float_t  int_ST_s                     = h_ST_s                            ->Integral(0,-1,0,-1); 
     Float_t  int_STbar_t                  = h_STbar_t                         ->Integral(0,-1,0,-1); 
     Float_t  int_ST_t                     = h_ST_t                            ->Integral(0,-1,0,-1); 
     Float_t  int_STbar_tW                 = h_STbar_tW                        ->Integral(0,-1,0,-1); 
     Float_t  int_ST_tW                    = h_ST_tW                           ->Integral(0,-1,0,-1); 

     Float_t  int_TTJets                   = h_TTJets                          ->Integral(0,-1,0,-1); 
     Float_t  int_TTtoLL                   = h_TTtoLL                          ->Integral(0,-1,0,-1); 
     Float_t  int_TTtoLfromTbar            = h_TTtoLfromTbar                   ->Integral(0,-1,0,-1); 
     Float_t  int_TTtoLfromT               = h_TTtoLfromT                      ->Integral(0,-1,0,-1); 
     Float_t  int_WJetsToLNu               = h_WJetsToLNu                      ->Integral(0,-1,0,-1); 
     Float_t  int_WG                       = h_WG                              ->Integral(0,-1,0,-1); 
     Float_t  int_ZG                       = h_ZG                              ->Integral(0,-1,0,-1); 
     Float_t  int_WW                       = h_WW                              ->Integral(0,-1,0,-1); 
     Float_t  int_WZ                       = h_WZ                              ->Integral(0,-1,0,-1); 
     Float_t  int_ZZ                       = h_ZZ                              ->Integral(0,-1,0,-1); 
     Float_t  int_WWTo2L2Nu                = h_WWTo2L2Nu                       ->Integral(0,-1,0,-1); 
     Float_t  int_WWToLNuQQ                = h_WWToLNuQQ                       ->Integral(0,-1,0,-1); 
     Float_t  int_WZTo1L3Nu                = h_WZTo1L3Nu                       ->Integral(0,-1,0,-1); 
     Float_t  int_WZTo3LNu                 = h_WZTo3LNu                        ->Integral(0,-1,0,-1); 
     Float_t  int_WZToLNu2QorQQ2L          = h_WZToLNu2QorQQ2L                 ->Integral(0,-1,0,-1); 
     Float_t  int_ZZTo2L2Nu                = h_ZZTo2L2Nu                       ->Integral(0,-1,0,-1); 
     Float_t  int_ZZTo2L2Q                 = h_ZZTo2L2Q                        ->Integral(0,-1,0,-1); 
     Float_t  int_ZZTo2Q2Nu                = h_ZZTo2Q2Nu                       ->Integral(0,-1,0,-1); 
     Float_t  int_ZZTo4L                   = h_ZZTo4L                          ->Integral(0,-1,0,-1); 
			       
     Float_t  int_Sig_ZH_MS15ct1000        = h_Sig_ZH_MS15ct1000               ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS15ct100         = h_Sig_ZH_MS15ct100                ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS15ct10          = h_Sig_ZH_MS15ct10                 ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS15ct1           = h_Sig_ZH_MS15ct1                  ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS40ct1000        = h_Sig_ZH_MS40ct1000               ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS40ct100         = h_Sig_ZH_MS40ct100                ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS40ct10          = h_Sig_ZH_MS40ct10                 ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS40ct1           = h_Sig_ZH_MS40ct1                  ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS55ct1000        = h_Sig_ZH_MS55ct1000               ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS55ct100         = h_Sig_ZH_MS55ct100                ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS55ct10          = h_Sig_ZH_MS55ct10                 ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ZH_MS55ct1           = h_Sig_ZH_MS55ct1                  ->Integral(0,-1,0,-1);                     

     Float_t  int_Sig_ggZH_MS15ct1000      = h_Sig_ggZH_MS15ct1000             ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS15ct100       = h_Sig_ggZH_MS15ct100              ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS15ct10        = h_Sig_ggZH_MS15ct10               ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS15ct1         = h_Sig_ggZH_MS15ct1                ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS40ct1000      = h_Sig_ggZH_MS40ct1000             ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS40ct100       = h_Sig_ggZH_MS40ct100              ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS40ct10        = h_Sig_ggZH_MS40ct10               ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS40ct1         = h_Sig_ggZH_MS40ct1                ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS55ct1000      = h_Sig_ggZH_MS55ct1000             ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS55ct100       = h_Sig_ggZH_MS55ct100              ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS55ct10        = h_Sig_ggZH_MS55ct10               ->Integral(0,-1,0,-1);                   
     Float_t  int_Sig_ggZH_MS55ct1         = h_Sig_ggZH_MS55ct1                ->Integral(0,-1,0,-1);                   

     // integrals of summed histograms
     Float_t int_DY        = h_DY       ->Integral(0,-1,0,-1); 
     Float_t int_altDY     = h_altDY    ->Integral(0,-1,0,-1); 
     Float_t int_GJets     = h_GJets    ->Integral(0,-1,0,-1); 
     Float_t int_ST        = h_ST       ->Integral(0,-1,0,-1); 
     Float_t int_ZH        = h_ZH       ->Integral(0,-1,0,-1); 
     Float_t int_VV        = h_VV       ->Integral(0,-1,0,-1); 
     Float_t int_altVV     = h_altVV    ->Integral(0,-1,0,-1); 
     Float_t int_TT        = h_TT       ->Integral(0,-1,0,-1); 
     Float_t int_altTT     = h_altTT    ->Integral(0,-1,0,-1); 
     Float_t int_VG        = h_VG       ->Integral(0,-1,0,-1); 
     Float_t int_QCD       = h_QCD      ->Integral(0,-1,0,-1); 
     Float_t int_bkgtotal  = h_bkgtotal ->Integral(0,-1,0,-1); 
     Float_t int_Data      = h_Data     ->Integral(0,-1,0,-1); 
     Float_t int_bkgOnData = (double)int_bkgtotal / int_Data ;
     Float_t int_Sig_MS15ct1000 = h_Sig_MS15ct1000 ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS15ct100  = h_Sig_MS15ct100  ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS15ct10   = h_Sig_MS15ct10   ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS15ct1    = h_Sig_MS15ct1    ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS40ct1000 = h_Sig_MS40ct1000 ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS40ct100  = h_Sig_MS40ct100  ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS40ct10   = h_Sig_MS40ct10   ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS40ct1    = h_Sig_MS40ct1    ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS55ct1000 = h_Sig_MS55ct1000 ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS55ct100  = h_Sig_MS55ct100  ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS55ct10   = h_Sig_MS55ct10   ->Integral(0,-1,0,-1);
     Float_t int_Sig_MS55ct1    = h_Sig_MS55ct1    ->Integral(0,-1,0,-1);
     /*
     Float_t  int_Data_SingleMu_H_3        = h_Data_SingleMu_H_3               ->Integral(0,-1,0,-1);                   
     Float_t  int_Data_SingleMu_H_2        = h_Data_SingleMu_H_2               ->Integral(0,-1,0,-1);                   
     Float_t  int_Data_SingleMu_G          = h_Data_SingleMu_G                 ->Integral(0,-1,0,-1);                   
     // Float_t  int_Data_SingleMu_F          = h_Data_SingleMu_F                 ->Integral(0,-1,0,-1);                   
     // Float_t  int_Data_SingleMu_E          = h_Data_SingleMu_E                 ->Integral(0,-1,0,-1);                   
     // Float_t  int_Data_SingleMu_D          = h_Data_SingleMu_D                 ->Integral(0,-1,0,-1);                   
     // Float_t  int_Data_SingleMu_C          = h_Data_SingleMu_C                 ->Integral(0,-1,0,-1);                   
     // Float_t  int_Data_SingleMu_B_2        = h_Data_SingleMu_B_2               ->Integral(0,-1,0,-1);                   
     Float_t  int_Data_SingleEle_H_3       = h_Data_SingleEle_H_3              ->Integral(0,-1,0,-1);                   
     Float_t  int_Data_SingleEle_H_2       = h_Data_SingleEle_H_2              ->Integral(0,-1,0,-1);                   
     Float_t  int_Data_SingleEle_G         = h_Data_SingleEle_G                ->Integral(0,-1,0,-1);                   
     */
     // Float_t  int_Data_SingleEle_F         = h_Data_SingleEle_F                ->Integral(0,-1,0,-1);                   
     // Float_t  int_Data_SingleEle_E         = h_Data_SingleEle_E                ->Integral(0,-1,0,-1);                   
     // Float_t  int_Data_SingleEle_D         = h_Data_SingleEle_D                ->Integral(0,-1,0,-1);                   
     // Float_t  int_Data_SingleEle_C         = h_Data_SingleEle_C                ->Integral(0,-1,0,-1);                   
     // Float_t  int_Data_SingleEle_B_2       = h_Data_SingleEle_B_2              ->Integral(0,-1,0,-1);                   
     Float_t  int_Data_SinglePhoton_H_3    = h_Data_SinglePhoton_H_3           ->Integral(0,-1,0,-1);                     
     Float_t  int_Data_SinglePhoton_H_2    = h_Data_SinglePhoton_H_2           ->Integral(0,-1,0,-1);                     
     Float_t  int_Data_SinglePhoton_G      = h_Data_SinglePhoton_G             ->Integral(0,-1,0,-1);                     
     // Float_t  int_Data_SinglePhoton_F      = h_Data_SinglePhoton_F             ->Integral(0,-1,0,-1);                     
     // Float_t  int_Data_SinglePhoton_E      = h_Data_SinglePhoton_E             ->Integral(0,-1,0,-1);                     
     // Float_t  int_Data_SinglePhoton_D      = h_Data_SinglePhoton_D             ->Integral(0,-1,0,-1);                     
     // Float_t  int_Data_SinglePhoton_C      = h_Data_SinglePhoton_C             ->Integral(0,-1,0,-1);                     
     // Float_t  int_Data_SinglePhoton_B_2    = h_Data_SinglePhoton_B_2           ->Integral(0,-1,0,-1);                     
     Float_t  int_Data_DoubleMu_H_3        = h_Data_DoubleMu_H_3               ->Integral(0,-1,0,-1);                     
     Float_t  int_Data_DoubleMu_H_2        = h_Data_DoubleMu_H_2               ->Integral(0,-1,0,-1);                     
     Float_t  int_Data_DoubleMu_G          = h_Data_DoubleMu_G                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleMu_F          = h_Data_DoubleMu_F                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleMu_E          = h_Data_DoubleMu_E                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleMu_D          = h_Data_DoubleMu_D                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleMu_C          = h_Data_DoubleMu_C                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleMu_B_2        = h_Data_DoubleMu_B_2               ->Integral(0,-1,0,-1);                     
     Float_t  int_Data_DoubleEG_H_3        = h_Data_DoubleEG_H_3               ->Integral(0,-1,0,-1);                     
     Float_t  int_Data_DoubleEG_H_2        = h_Data_DoubleEG_H_2               ->Integral(0,-1,0,-1);                     
     Float_t  int_Data_DoubleEG_G          = h_Data_DoubleEG_G                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleEG_F          = h_Data_DoubleEG_F                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleEG_E          = h_Data_DoubleEG_E                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleEG_D          = h_Data_DoubleEG_D                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleEG_C          = h_Data_DoubleEG_C                 ->Integral(0,-1,0,-1);                     
     //Float_t  int_Data_DoubleEG_B_2        = h_Data_DoubleEG_B_2               ->Integral(0,-1,0,-1);                 
...
//     fprintf (outfulltable, "Data DoubleEG B 2       & %3.1f \\\\\n", int_Data_DoubleEG_B_2      ) ; 
     ...
     //h_Sig_MS40ct10->SetFillColor(kBlack);
     ...
     h_DY         ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     h_GJets      ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     h_ST         ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     h_TT         ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     h_WJetsToLNu ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     h_VV         ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     h_VG         ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     h_QCD        ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     h_ZH         ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     h_Sig_MS40ct10->Scale(1./h_Sig_MS40ct10->Integral(0,-1,0,-1));
     h_bkgtotal   ->Scale(1./h_bkgtotal->Integral(0,-1,0,-1));
     // make stack
     THStack *bgstack = new THStack("bgstack","");
     if(dolog){
      std::sort(v.begin(), v.end(),
		[](TH2F *a, TH2F *b) { return a->Integral() < b->Integral(); });
...
//     }
     ...
     // set max and draw
     Double_t ymax;
     //ymax = std::max(h_sig_ms40ct10->getmaximum(), h_bkgtotal->GetMaximum() );
     //
     ymax=h_Sig_MS40ct10->GetMaximum();
      //if(dolog){
     //} 
     //else {
     ...
     plotpad->cd();
     //bgstack->GetXaxis()->SetRangeUser(0,12);
     // bgstack->SetMaximum(0.08); 
     // bgstack->SetMinimum(0);
     bgstack->Draw();
     ////bgstack->Draw("hist e");
     ...
     bgstack->GetXaxis()->SetTitleOffset(1.75);
     bgstack->GetYaxis()->SetTitleOffset(2.75);
     //bgstack->GetXaxis()->SetTitle(region+"_"+varname + "    "+description);
     bgstack->GetXaxis()->SetTitle(region+"_"+"AvfVertexTrackEnergy" + "    "+description);
     bgstack->GetYaxis()->SetTitle(region+"_"+"AlphaMax" + "    "+description);
     //if(!drawData){
     ...
     if(drawSignal){
       ...
       //h_Sig_MS40ct10->GetXaxis()->SetRangeUser(0,12);
       //h_Sig_MS40ct10->SetMaximum(0.1); 
       //h_Sig_MS40ct10->SetMinimum(0);
       h_Sig_MS40ct10->Draw("LEGO") ;
       //h_Sig_MS15ct100->Scale(1./h_Sig_MS15ct100->Integral(0,-1,0,-1));
       //h_Sig_MS15ct100->SetFillColor(kBlack);
       //h_Sig_MS15ct100->Draw("hist same") ;
       sigleg->Draw();
     }
     canvas->cd();
     leg->Draw();
     ...
     // add titles
     title->DrawTextNDC(0.05,0.91,"CMS");
     ...
     lumi->DrawTextNDC(0.92,0.91,(TString)lumistring+" /fb (13 TeV)");
     
     if(drawData){
       ratiopad->cd();
       h_ratio = (TH2F*)h_Data->Clone("ratio");
       if(h_Data->Integral(-1,-1,-1,-1)>0){
