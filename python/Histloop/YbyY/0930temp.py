...
temp=[]
_file0 = TFile.Open('dosemap_output_2forall.root','read')
hE = TH1F("1D_Signal","EOLAll2mm2_SignalDispersion_L50", 100, 0, 100)
...
c1.SaveAs('L50EOL2mmsipm.png')
c1.SaveAs('L50EOL2mmsipm.pdf')
k=raw_input('Press ENTER to exit')
