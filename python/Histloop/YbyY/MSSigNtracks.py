...
for i in range(len(Region)):
	for j in range(len(TV)):
		...
		Channel = Region[i]
		Var = TV[j]
		_file0 = TFile.Open('/uscms/home/skim2/nobackup/temproot/new%s_ZH_HToSSTobbbb_ZToLL_MH-125_MS-55_ctauS-100.root' %Channel,'read')
		_file1 = TFile.Open('/uscms/home/skim2/nobackup/temproot/new%s_ZH_HToSSTobbbb_ZToLL_MH-125_MS-40_ctauS-100.root' %Channel,'read')
		...
		legend.SetTextSize(.0175)
   		...
   		legend.SetFillColor(kWhite)
		legend.AddEntry(h0,"55GeV_100mm","l")
		legend.AddEntry(h1,"40GeV_100mm","l")
		...
		c1.SaveAs('MSSig_%s_%s.pdf'%(Channel,Var))
k=raw_input('Press ENTER to exit')
