...
TV = ['AllTags_AODCaloJetTagAvfVxy1D','AllJets_AODCaloJetAvfVxy1D']
...
for i in range(len(Region)):
	for j in range(len(TV)):
		...
		extra2.SetTextFont(62)
    		...
    		extra2.DrawLatexNDC(0.55,0.91,"Run2 DY")
		c1.Modified()
		c1.Update()
		#k=raw_input('Press ENTER to exit')
		c1.SaveAs('Avf_%s_%s.pdf'%(Channel,Var))
k=raw_input('Press ENTER to exit')
