...
#TV = ['AllTags_AODCaloJetTag_energyFractionHadronic']
TV = ['AllTags_AODCaloJetTag_emEnergyFraction']
#TV = ['AllTags_AODCaloJetTag_emHadronicratio']
...
for i in range(len(Region)):
	for j in range(len(TV)):
		...
		h0.SetTitle('Tagged Jet - em Energy fraction')
		h0.GetXaxis().SetTitle('emEnergyFraction')
		#h0.GetXaxis().SetTitle('%s' %Var)
		h0.GetYaxis().SetTitle('(Unit Normalized) Counts')
		h0.GetYaxis().SetTitleOffset(1.5)
		h0.Scale(1./h0.Integral())
		h0.SetLineColor(2)
		h0.Draw('HIST')
		#h0.GetYaxis().SetRangeUser(0.000001,0.4)
		h0.GetYaxis().SetRangeUser(0.000001,0.15)
