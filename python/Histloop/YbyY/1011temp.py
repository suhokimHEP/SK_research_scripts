...
temp=[]
_file0 = TFile.Open('dosemap_output_Oct4.root','read')
hE = TH1F("1D_TileLength","TileLength", 100, 0, 10)
for i in range(8,21):
	#print("Layer")
	#print(i)
	h0=_file0.Get('plotter/tilelength_lay%d_ieta'%i)
...
print(minval)
print(maxval)
hE.GetXaxis().SetTitle('TileLength(cm)')
...
#legend.Draw()
avg = hE.GetMean()
str2='min(TileLeng) ='+str(minval)
str1='max(TileLeng) ='+str(maxval)
str3='(max-min)/avg ='+str((maxval-minval)/avg)
