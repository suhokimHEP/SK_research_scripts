...
for i in range(len(Region)):
	for j in range(len(TV)):
		...
		h0=_file0.Get('h_%s_%s_0truePU'  % (Channel,Var))
		h1=_file0.Get('h_%s_%s_20truePU' % (Channel,Var))
		h2=_file0.Get('h_%s_%s_30truePU' % (Channel,Var))
		h3=_file0.Get('h_%s_%s_40truePU' % (Channel,Var))
		...
		legend.SetTextSize(.0175)
   		...
   		legend.SetFillColor(kWhite)
		legend.AddEntry(h0,"AODnTruePU<20","l")
		legend.AddEntry(h1,"AODnTruePU>20 && <30","l")
		legend.AddEntry(h2,"AODnTruePU>30 && <40","l")
		legend.AddEntry(h3,"AODnTruePU>40","l")
		legend.Draw()
		title = TText(1,1,"") 
		...
		extra2.SetTextFont(62)
    		...
    		extra2.DrawLatexNDC(0.55,0.91,"Run2 DY PU v. TagVars")
		c1.Modified()
		c1.Update()
		#k=raw_input('Press ENTER to exit')
		c1.SaveAs('DYPU_%s_%s.pdf'%(Channel,Var))
k=raw_input('Press ENTER to exit')
